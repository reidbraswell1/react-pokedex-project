...
const DetailsPage = (props) => {
    ...
    console.log(`---Begin Function ${DetailsPage.name}()---`);
    ...
    console.log(`${DetailsPage.name} Props =`, props);
    console.log(`${DetailsPage.name} Params =`, params);
    console.log(`${DetailsPage.name} Location =`, location);
                    ...
                    <div className="row">
                        <div className="col-4 mx-auto">
                            <h1 className="color-white text-center">
                                ...
                                {pokemon.name} {props.pageTitle}</h1>
                        </div>
                    </div>
                    <div className="row">
